	...
	<nav class="navbar bg-gradient-to-b from-base-100 to-transparent sticky top-0 z-50">
		<div class="container mx-auto flex items-center justify-between px-4">
			...
			<div class="flex items-center space-x-2">
				...
				>
					<!-- Sun Icon (Light Mode) -->
					<svg class="swap-on fill-current w-6 h-6 transition-transform duration-500" xmlns="http://www.w3.org/2000/svg"
					     viewBox="0 0 24 24">
						<path
					...
					<!-- Moon Icon (Dark Mode) -->
					<svg class="swap-off fill-current w-6 h-6 transition-transform duration-500"
