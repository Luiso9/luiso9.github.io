 ...
 */var wr=Symbol.for("react.element"),ud=Symbol.for("react.portal"),cd=Symbol.for("react.fragment"),fd=Symbol.for("react.strict_mode"),dd=Symbol.for("react.profiler"),pd=Symbol.for("react.provider"),md=Symbol.for("react.context"),hd=Symbol.for("react.forward_ref"),yd=Symbol.for("react.suspense"),vd=Symbol.for("react.memo"),gd=Symbol.for("react.lazy"),ts=Symbol.iterator;function wd(e){return e===null||typeof e!="object"?null:(e=ts&&e[ts]||e["@@iterator"],typeof e=="function"?e:null)}var Su={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Eu=Object.assign,Cu={};function Cn(e,t,n){this.props=e,this.context=t,this.refs=Cu,this.updater=n||Su}Cn.prototype.isReactComponent={};Cn.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};Cn.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function _u(){}_u.prototype=Cn.prototype;function Ki(e,t,n){this.props=e,this.context=t,this.refs=Cu,this.updater=n||Su}var Gi=Ki.prototype=new _u;Gi.constructor=Ki;Eu(Gi,Cn.prototype);Gi.isPureReactComponent=!0;var ns=Array.isArray,Nu=Object.prototype.hasOwnProperty,Zi={current:null},zu={key:!0,ref:!0,__self:!0,__source:!0};function Pu(e,t,n){var r,o={},l=null,i=null;if(t!=null)for(r in t.ref!==void 0&&(i=t.ref),t.key!==void 0&&(l=""+t.key),t)Nu.call(t,r)&&!zu.hasOwnProperty(r)&&(o[r]=t[r]);var a=arguments.length-2;if(a===1)o.children=n;else if(1<a){for(var s=Array(a),c=0;c<a;c++)s[c]=arguments[c+2];o.children=s}if(e&&e.defaultProps)for(r in a=e.defaultProps,a)o[r]===void 0&&(o[r]=a[r]);return{$$typeof:wr,type:e,key:l,ref:i,props:o,_owner:Zi.current}}function xd(e,t){return{$$typeof:wr,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Ji(e){return typeof e=="object"&&e!==null&&e.$$typeof===wr}function kd(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var rs=/\/+/g;function Sl(e,t){return typeof e=="object"&&e!==null&&e.key!=null?kd(""+e.key):t.toString(36)}function Xr(e,t,n,r,o){var l=typeof e;(l==="undefined"||l==="boolean")&&(e=null);var i=!1;if(e===null)i=!0;else switch(l){case"string":case"number":i=!0;break;case"object":switch(e.$$typeof){case wr:case ud:i=!0}}if(i)return i=e,o=o(i),e=r===""?"."+Sl(i,0):r,ns(o)?(n="",e!=null&&(n=e.replace(rs,"$&/")+"/"),Xr(o,t,n,"",function(c){return c})):o!=null&&(Ji(o)&&(o=xd(o,n+(!o.key||i&&i.key===o.key?"":(""+o.key).replace(rs,"$&/")+"/")+e)),t.push(o)),1;if(i=0,r=r===""?".":r+":",ns(e))for(var a=0;a<e.length;a++){l=e[a];var s=r+Sl(l,a);i+=Xr(l,t,n,s,o)}else if(s=wd(e),typeof s=="function")for(e=s.call(e),a=0;!(l=e.next()).done;)l=l.value,s=r+Sl(l,a++),i+=Xr(l,t,n,s,o);else if(l==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return i}function zr(e,t,n){if(e==null)return e;var r=[],o=0;return Xr(e,r,"","",function(l){return t.call(n,l,o++)}),r}function Sd(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(n){(e._status===0||e._status===-1)&&(e._status=1,e._result=n)},function(n){(e._status===0||e._status===-1)&&(e._status=2,e._result=n)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var ge={current:null},Kr={transition:null},Ed={ReactCurrentDispatcher:ge,ReactCurrentBatchConfig:Kr,ReactCurrentOwner:Zi};function Tu(){throw Error("act(...) is not supported in production builds of React.")}j.Children={map:zr,forEach:function(e,t,n){zr(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return zr(e,function(){t++}),t},toArray:function(e){return zr(e,function(t){return t})||[]},only:function(e){if(!Ji(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};j.Component=Cn;j.Fragment=cd;j.Profiler=dd;j.PureComponent=Ki;j.StrictMode=fd;j.Suspense=yd;j.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Ed;j.act=Tu;j.cloneElement=function(e,t,n){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=Eu({},e.props),o=e.key,l=e.ref,i=e._owner;if(t!=null){if(t.ref!==void 0&&(l=t.ref,i=Zi.current),t.key!==void 0&&(o=""+t.key),e.type&&e.type.defaultProps)var a=e.type.defaultProps;for(s in t)Nu.call(t,s)&&!zu.hasOwnProperty(s)&&(r[s]=t[s]===void 0&&a!==void 0?a[s]:t[s])}var s=arguments.length-2;if(s===1)r.children=n;else if(1<s){a=Array(s);for(var c=0;c<s;c++)a[c]=arguments[c+2];r.children=a}return{$$typeof:wr,type:e.type,key:o,ref:l,props:r,_owner:i}};j.createContext=function(e){return e={$$typeof:md,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:pd,_context:e},e.Consumer=e};j.createElement=Pu;j.createFactory=function(e){var t=Pu.bind(null,e);return t.type=e,t};j.createRef=function(){return{current:null}};j.forwardRef=function(e){return{$$typeof:hd,render:e}};j.isValidElement=Ji;j.lazy=function(e){return{$$typeof:gd,_payload:{_status:-1,_result:e},_init:Sd}};j.memo=function(e,t){return{$$typeof:vd,type:e,compare:t===void 0?null:t}};j.startTransition=function(e){var t=Kr.transition;Kr.transition={};try{e()}finally{Kr.transition=t}};j.unstable_act=Tu;j.useCallback=function(e,t){return ge.current.useCallback(e,t)};j.useContext=function(e){return ge.current.useContext(e)};j.useDebugValue=function(){};j.useDeferredValue=function(e){return ge.current.useDeferredValue(e)};j.useEffect=function(e,t){return ge.current.useEffect(e,t)};j.useId=function(){return ge.current.useId()};j.useImperativeHandle=function(e,t,n){return ge.current.useImperativeHandle(e,t,n)};j.useInsertionEffect=function(e,t){return ge.current.useInsertionEffect(e,t)};j.useLayoutEffect=function(e,t){return ge.current.useLayoutEffect(e,t)};j.useMemo=function(e,t){return ge.current.useMemo(e,t)};j.useReducer=function(e,t,n){return ge.current.useReducer(e,t,n)};j.useRef=function(e){return ge.current.useRef(e)};j.useState=function(e){return ge.current.useState(e)};j.useSyncExternalStore=function(e,t,n){return ge.current.useSyncExternalStore(e,t,n)};j.useTransition=function(){return ge.current.useTransition()};j.version="18.3.1";ku.exports=j;var R=ku.exports;const Cd=sd(R),os=ad({__proto__:null,default:Cd},[R]);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,L){var O=z.length;z.push(L);e:for(;0<O;){var Z=O-1>>>1,ne=z[Z];if(0<o(ne,L))z[Z]=L,z[O]=ne,O=Z;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var L=z[0],O=z.pop();if(O!==L){z[0]=O;e:for(var Z=0,ne=z.length,_r=ne>>>1;Z<_r;){var Rt=2*(Z+1)-1,kl=z[Rt],$t=Rt+1,Nr=z[$t];if(0>o(kl,O))$t<ne&&0>o(Nr,kl)?(z[Z]=Nr,z[$t]=O,Z=$t):(z[Z]=kl,z[Rt]=O,Z=Rt);else if($t<ne&&0>o(Nr,O))z[Z]=Nr,z[$t]=O,Z=$t;else break e}}return L}function o(z,L){var O=z.sortIndex-L.sortIndex;return O!==0?O:z.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,a=i.now();e.unstable_now=function(){return i.now()-a}}var s=[],c=[],m=1,p=null,h=3,w=!1,g=!1,y=!1,T=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(z){for(var L=n(c);L!==null;){if(L.callback===null)r(c);else if(L.startTime<=z)r(c),L.sortIndex=L.expirationTime,t(s,L);else break;L=n(c)}}function v(z){if(y=!1,d(z),!g)if(n(s)!==null)g=!0,wl(E);else{var L=n(c);L!==null&&xl(v,L.startTime-z)}}function E(z,L){g=!1,y&&(y=!1,f(P),P=-1),w=!0;var O=h;try{for(d(L),p=n(s);p!==null&&(!(p.expirationTime>L)||z&&!Ve());){var Z=p.callback;if(typeof Z=="function"){p.callback=null,h=p.priorityLevel;var ne=Z(p.expirationTime<=L);L=e.unstable_now(),typeof ne=="function"?p.callback=ne:p===n(s)&&r(s),d(L)}else r(s);p=n(s)}if(p!==null)var _r=!0;else{var Rt=n(c);Rt!==null&&xl(v,Rt.startTime-L),_r=!1}return _r}finally{p=null,h=O,w=!1}}var _=!1,S=null,P=-1,G=5,$=-1;function Ve(){return!(e.unstable_now()-$<G)}function Pn(){if(S!==null){var z=e.unstable_now();$=z;var L=!0;try{L=S(!0,z)}finally{L?Tn():(_=!1,S=null)}}else _=!1}var Tn;if(typeof u=="function")Tn=function(){u(Pn)};else if(typeof MessageChannel<"u"){var es=new MessageChannel,id=es.port2;es.port1.onmessage=Pn,Tn=function(){id.postMessage(null)}}else Tn=function(){T(Pn,0)};function wl(z){S=z,_||(_=!0,Tn())}function xl(z,L){P=T(function(){z(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,wl(E))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(z){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var O=h;h=L;try{return z()}finally{h=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,L){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var O=h;h=z;try{return L()}finally{h=O}},e.unstable_scheduleCallback=function(z,L,O){var Z=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?Z+O:Z):O=Z,z){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=O+ne,z={id:m++,callback:L,priorityLevel:z,startTime:O,expirationTime:ne,sortIndex:-1},O>Z?(z.sortIndex=O,t(c,z),n(s)===null&&z===n(c)&&(y?(f(P),P=-1):y=!0,xl(v,O-Z))):(z.sortIndex=ne,t(s,z),g||w||(g=!0,wl(E))),z},e.unstable_shouldYield=Ve,e.unstable_wrapCallback=function(z){var L=h;return function(){var O=h;h=L;try{return z.apply(this,arguments)}finally{h=O}}}})(Ru);ju.exports=Ru;var Od=ju.exports;/**
 * @license React
...
`;function N1(){const[e,t]=R.useState(()=>localStorage.getItem("darkMode")==="true");R.useEffect(()=>{document.documentElement.classList.toggle("dark",e)},[e]);const n=()=>{t(!e),localStorage.setItem("darkMode",!e)};return C.jsx(C.Fragment,{children:C.jsx("nav",{id:"header",className:"top-0 z-30 w-full bg-white py-1 transition-colors duration-500 ease-in-out dark:bg-black",children:C.jsxs("div",{className:"container mx-auto mt-0 flex w-full flex-wrap items-center justify-between py-3",children:[C.jsx("label",{htmlFor:"menu-toggle",className:"block cursor-pointer md:hidden",children:C.jsxs("svg",{className:"fill-current text-gray-900 dark:text-gray-200",xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 20 20",children:[C.jsx("title",{children:"menu"}),C.jsx("path",{d:"M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"})]})}),C.jsx("input",{className:"hidden",type:"checkbox",id:"menu-toggle"}),C.jsx("div",{className:"order-3 hidden w-full md:order-1 md:flex md:w-auto md:items-center",id:"menu",children:C.jsx("nav",{children:C.jsxs("ul",{className:"items-center justify-between pt-4 text-base text-gray-700 transition-colors duration-500 ease-in-out dark:text-gray-300 md:flex md:pt-0",children:[C.jsx("li",{children:C.jsx("a",{className:"inline-block py-2 no-underline hover:text-black hover:underline dark:hover:text-white",href:"#",children:"About"})}),C.jsx("li",{children:C.jsx("a",{className:"ml-4 inline-block py-2 no-underline hover:text-black hover:underline dark:hover:text-white",href:"#",children:"Certificate"})})]})})}),C.jsx("div",{className:"order-1 md:order-2",children:C.jsx("a",{className:"flex items-center justify-center text-xl font-bold tracking-wide text-gray-800 no-underline transition-colors duration-500 ease-in-out hover:no-underline dark:text-gray-200",href:"#",children:"PORTFOLIO"})}),C.jsx("div",{className:"order-2 flex items-center justify-center md:order-3",id:"nav-content",children:C.jsx("button",{onClick:n,className:"inline-block no-underline transition-colors duration-500 ease-in-out hover:text-black focus:outline-none dark:hover:text-white",children:e?C.jsx("svg",{className:"fill-current text-gray-900 dark:text-gray-200",xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",children:C.jsx("path",{d:"M12 2a9.93 9.93 0 0 0-6.944 2.9 1 1 0 0 0 1.146 1.635A7.96 7.96 0 1 1 10.466 19.8a1 1 0 0 0-1.635 1.145A9.93 9.93 0 1 0 12 2z"})}):C.jsx("svg",{className:"fill-current text-gray-900 dark:text-gray-200",xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",children:C.jsx("path",{d:"M6.76 4.84l-1.8-1.8a1 1 0 1 1 1.42-1.42l1.8 1.8a1 1 0 0 1-1.42 1.42zm10.48 0a1 1 0 0 1-1.42-1.42l1.8-1.8a1 1 0 0 1 1.42 1.42l-1.8 1.8zm-7.6 14.32a1 1 0 0 1 1.42-1.42l1.8 1.8a1 1 0 1 1-1.42 1.42l-1.8-1.8zm10.48-1.42a1 1 0 0 1 1.42 1.42l-1.8 1.8a1 1 0 1 1-1.42-1.42l-1.8-1.8zm-5.12-4.76a5 5 0 1 1-10 0 5 5 0 0 1 10 0zm-5-3a1 1 0 0 1 0 2 1 1 0 0 1 0-2zm0 6a1 1 0 0 1 0 2 1 1 0 0 1 0-2zm-6-3a1 1 0 0 1 2 0 1 1 0 0 1-2 0zm12 0a1 1 0 0 1 2 0 1 1 0 0 1-2 0zm-9.9-6.1a1 1 0 0 1 1.42 0l1.8 1.8a1 1 0 0 1-1.42 1.42l-1.8-1.8a1 1 0 0 1 0-1.42zm10.48 10.48a1 1 0 0 1 1.42 0l1.8 1.8a1 1 0 0 1-1.42 1.42l-1.8-1.8a1 1 0 0 1 0-1.42z"})})})})]})})})}function z1(){const[e,t]=R.useState(()=>localStorage.getItem("darkMode")==="true"),[n,r]=R.useState(!1);return R.useEffect(()=>{document.documentElement.classList.toggle("dark",e)},[e]),C.jsx(C.Fragment,{children:C.jsx("div",{className:`mx-auto flex w-full bg-cover bg-right pt-12 md:items-center md:pt-0 transition-opacity duration-300 ${n?"opacity-0":"opacity-100"}`,style:{maxWidth:"1600px",height:"32rem",backgroundImage:"url('https://images.unsplash.com/photo-1718081591976-64a345c4f92e?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"},children:C.jsx("div",{className:"container mx-auto",children:C.jsxs("div",{className:"flex w-full flex-col items-start justify-center px-6 tracking-wide lg:w-1/2",children:[C.jsx("h1",{className:"my-4 text-2xl text-white dark:text-white transition-colors duration-500 ease-in-out",children:"Hello, I am Muhammad Andrian Saputra"}),C.jsx("a",{className:"inline-block text-white border-b border-gray-600 text-xl leading-relaxed no-underline hover:border-black hover:text-black dark:border-gray-300 dark:hover:border-white dark:hover:text-white transition-colors duration-500 ease-in-out",href:"#about",children:"Explore"})]})})})})}function P1(){return C.jsx(C.Fragment,{children:C.jsx("div",{id:"about",className:"max-w-full overflow-hidden bg-white py-20 transition-colors duration-500 ease-in-out dark:bg-black md:py-28",children:C.jsxs("div",{className:"px-4 lg:px-20",children:[C.jsxs("div",{className:"mb-3 flex h-full w-full flex-col items-center justify-center",children:[C.jsx("h2",{className:"text-4xl font-bold uppercase tracking-widest text-black transition-colors duration-500 ease-in-out dark:text-white",children:"About Me"}),C.jsx("div",{className:"my-4 h-[2px] w-12 rounded-md bg-gray-600 dark:bg-white"}),C.jsx("span",{className:"w-11/12 text-center text-sm font-medium tracking-wide text-black transition-colors duration-500 ease-in-out dark:text-white lg:text-lg mb-8",children:"Disini saya menjelaskan singkat mengenai ketertarikan saya sebagai Front-End Developer."})]}),C.jsxs("div",{className:"mt-4 flex w-full flex-col justify-start lg:flex-row",children:[C.jsxs("div",{className:"my-16 font-sans font-medium lg:my-0 lg:w-1/2 lg:p-3",children:[C.jsx("h2",{className:"mb-2 text-2xl font-bold tracking-wide",children:"Know About me!"}),C.jsxs("div",{className:"mb-6 font-normal tracking-wide text-black transition-colors duration-500 ease-in-out dark:text-white",children:[C.jsxs("p",{className:"my-3",children:["Halo! Saya Muhammad Andrian Saputra,"," ",C.jsx("span",{className:"font-semibold",children:"Seorang Front-end Developer Ototdidak."})," ","Tinggal di Yogyakarta. Keahlian saya"," ",C.jsx("span",{className:"",children:"JavaScript, Node.js, PHP, dan React.js, termasuk Front-End serta Back-End sedikitnya"}),"."]}),C.jsxs("p",{className:"my-3",children:["saya telah mempelajari dasar-dasar Jaringan Komputer, namun saya menemukan passion saya dalam mengembangkan interface user yang menarik dan fungsional untuk web."," ",C.jsx("span",{className:"font-semibold",children:"Minat saya pada Front-End Development berawal dari ketertarikan pada desain dan interaktivitas yang dapat memberikan pengalaman pengguna yang menyenangkan."})," ","Saya selalu antusias."]}),C.jsx("p",{className:"my-3",children:"Selama ini, saya telah mengasah keterampilan saya dalam HTML, CSS, JavaScript, dan PHP, serta menggunakan framework seperti React atau Laravel untuk membuat aplikasi web."}),C.jsx("p",{className:"my-3",children:"Meskipun saya masih dalam tahap pendidikan, saya berfokus pada pengembangan interface pengguna yang intuitif dan responsif. Melalui proyek-proyek pribadi, saya berusaha untuk selalu menghadirkan hasil yang memenuhi standar kualitas tinggi dan memberikan pengalaman pengguna yang optimal."})]}),C.jsx("button",{className:"rounded-sm bg-zinc-800 px-10 py-5 font-sans font-semibold uppercase tracking-widest text-white duration-200 ease-linear hover:-translate-y-1 hover:bg-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-950",children:"Contact"})]}),C.jsx("div",{className:"lg:w-1/2 lg:px-5",children:C.jsxs("div",{className:"",children:[C.jsx("h2",{className:"mb-6 text-2xl font-bold",children:"My Skills"}),C.jsxs("div",{className:"my-3 flex flex-wrap gap-4 text-xs lg:text-lg",children:[C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"JavaScript"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"Node.js"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"React.js"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"PHP"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"MySQL"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"HTML"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"CSS"}),C.jsx("span",{className:"rounded-lg bg-zinc-800 px-5 py-3 text-base font-medium text-gray-300 dark:text-white",children:"TailwindCSS"})]})]})})]})]})})})}function T1(){const[e,t]=R.useState(()=>localStorage.getItem("darkMode")==="true");return R.useEffect(()=>{document.documentElement.classList.toggle("dark",e),document.body.style.backgroundColor=e?"black":"white"},[e]),C.jsxs(C.Fragment,{children:[C.jsxs(wu,{cascade:!0,damping:.1,triggerOnce:!0,className:"bg-white transition-colors duration-500 ease-in-out dark:bg-black",children:[C.jsx(N1,{}),C.jsx(z1,{})]}),C.jsx(wu,{direction:"left",triggerOnce:!0,children:C.jsx(P1,{})})]})}Rf(document.getElementById("root")).render(C.jsx(R.StrictMode,{children:C.jsx(T1,{})}));
